...
public class MainActivity extends Activity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    DatePickerDialog evaluation_date_picker;
    DatePickerDialog maturity_date_picker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        evaluation_date_set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                maxDate.set(Calendar.YEAR, MainActivity.this.myMaturityDate.getYear());
                maxDate.set(Calendar.MONTH, MainActivity.this.myMaturityDate.getMonth()-1);
                maxDate.set(Calendar.DATE, MainActivity.this.myMaturityDate.getDay());

                MainActivity.this.evaluation_date_picker = new DatePickerDialog(MainActivity.this,
                        MainActivity.this.pickerListenerEvalDate,
                ...
                MainActivity.this.evaluation_date_picker.getDatePicker().setMinDate(minDate.getTimeInMillis());
                MainActivity.this.evaluation_date_picker.getDatePicker().setMaxDate(maxDate.getTimeInMillis());
        ...
        maturity_date_set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Calendar minDate = Calendar.getInstance();
                Calendar maxDate = Calendar.getInstance();
                minDate.set(Calendar.YEAR, MainActivity.this.myEvaluationDate.getYear());
                minDate.set(Calendar.MONTH, MainActivity.this.myEvaluationDate.getMonth()-1);
                minDate.set(Calendar.DATE, MainActivity.this.myEvaluationDate.getDay());
                maxDate.set(2075, Calendar.DECEMBER, 31);

                MainActivity.this.maturity_date_picker = new DatePickerDialog(MainActivity.this,
                        MainActivity.this.pickerListenerMaturityDate,
                        MainActivity.this.myMaturityDate.getYear(),
                        MainActivity.this.myMaturityDate.getMonth()-1,
                        MainActivity.this.myMaturityDate.getDay());

                MainActivity.this.maturity_date_picker.getDatePicker().setMinDate(minDate.getTimeInMillis());
                MainActivity.this.maturity_date_picker.getDatePicker().setMaxDate(maxDate.getTimeInMillis());
    ...
    public void onClick(View view) {
        if (!this.validate(this.spotLevel.getText().toString(), this.strike.getText().toString(),
            ...
            BinomialModel myModel = new BinomialModel(_spotLevel, _rate, _dividend, _volatility, 3, _maturity);

            AmericanOption myOption;

            if (this.selected_type.equals("Standard Call"))
                myOption = new AmericanCallOption(myModel, _strike);
            else if (this.selected_type.equals("Standard Put"))
                myOption = new AmericanPutOption(myModel, _strike);
            else if (this.selected_type.equals("Binary Call"))
                myOption = new BinaryCallOption(myModel, _strike);
            else if (this.selected_type.equals("Binary Put"))
                myOption = new BinaryPutOption(myModel, _strike);
            else
                myOption = new AmericanCallOption(myModel, _strike);

            if (view.getId()==R.id.greeksButton){
                Intent i = new Intent(this, GreekResults.class);
                i.putExtra("financial.stockmarket.derivatives.DELTA", myOption.calculateGreeks("DELTA"));
                i.putExtra("financial.stockmarket.derivatives.VEGA", myOption.calculateGreeks("VEGA"));
                i.putExtra("financial.stockmarket.derivatives.THETA", myOption.calculateGreeks("THETA"));
                i.putExtra("financial.stockmarket.derivatives.RHO", myOption.calculateGreeks("RHO"));
                i.putExtra("financial.stockmarket.derivatives.DIVIDEND_DELTA",
                        myOption.calculateGreeks("DIVIDEND"));
                startActivity(i);
            }
            else {
                Intent i = new Intent(this, Results.class);
                i.putExtra("financial.stockmarket.derivatives.PRICE_RESULT", myOption.evaluate());
                startActivity(i);
            }
